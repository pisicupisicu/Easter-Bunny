...
<div class="team-footer">
       ...
       <span class="appx-mmr">Team MMR: 3083</span>
    
    <div>
        <span>Banned Champions</span>
        
        <i title="Ban # 1 Elise" class="icon champions-lol-28 elise tip">
        </i>
        
        <i title="Ban # 3 Nidalee" class="icon champions-lol-28 nidalee tip">
        </i>
        
        <i title="Ban # 5 Shyvana" class="icon champions-lol-28 shyvana tip">
        </i>
